...
| Hosting/Edge & AI | Cloudflare Workers + Agents SDK (`@cloudflare/think` + Agent Skills) |
...
- Selector de kilos con cantidad por corte
- Búsqueda por nombre y filtro por categoría (Clásicos / Premium)
- 3 combos recomendados consultables por WhatsApp
- Fotos AI generadas por Workers AI con FLUX-1-schnell

### Carrito de compras
- Agregar cortes con cantidad en kg
- Vista del pedido con cortes seleccionados y kilos totales
- Persistencia en localStorage (sobrevive recargas)
- Envío del pedido formateado por WhatsApp (sin precios, cotización directa)
